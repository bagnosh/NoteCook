...
import { addRecipe, updateRecipe } from '../constants/storage';
...
export default function EditRecipeScreen() {
  ...
  const rawRecipe = params.new === 'true' ? null : (params.recipe ?? null);
  const existing: Recipe | null = rawRecipe ? JSON.parse(rawRecipe as string) : null;
  ...
  }, [params.new, params.recipe, params.timestamp]);
